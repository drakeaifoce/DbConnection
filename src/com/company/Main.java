...
import com.company.repositories.LocomotiveRepository;
...
//        MyApplication app = new MyApplication(repo);
        ITrainRepository trainRepository = new TrainRepository(db);
        ILocomotiveRepository locomotiveRepository = new LocomotiveRepository(db);
        TrainFrontEnd app = new TrainFrontEnd(trainRepository, locomotiveRepository);
        app.start();
    }
}